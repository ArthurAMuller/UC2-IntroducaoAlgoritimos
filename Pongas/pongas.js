...
const raquete = {
  ...
  altura: 80,                  // Altura da raquete
  velocidade: 12              // Velocidade com que a raquete se move para cima ou para baixo
};
...
const bola = {
  ...
  dx: 4,                      // Velocidade e direção horizontal da bola (9 pixels por frame)
  dy: 4                       // Velocidade e direção vertical da bola (9 pixels por frame)
};
